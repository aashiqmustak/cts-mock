...
class DataRepository {
  ...
  static const List<Patient> _defaultPatients = [
    Patient(
      ...
      totalAuthorizations: 8, approvedAuthorizations: 8, pendingAuthorizations: 0,
      mrn: 'MRN-0045231',
    ...
    Patient(
      ...
      facilityId: 'fac-001',
      totalAuthorizations: 12, approvedAuthorizations: 12, pendingAuthorizations: 0,
      mrn: 'MRN-0067892',
    ...
    Patient(
      ...
      facilityId: 'fac-002',
      totalAuthorizations: 15, approvedAuthorizations: 15, pendingAuthorizations: 0,
      mrn: 'MRN-0089123',
    ),
    Patient(
      ...
      totalAuthorizations: 6, approvedAuthorizations: 6, pendingAuthorizations: 0,
      mrn: 'MRN-0034567',
    ),
    Patient(
      ...
      facilityId: 'fac-002',
      totalAuthorizations: 9, approvedAuthorizations: 9, pendingAuthorizations: 0,
      mrn: 'MRN-0056789',
    ),
    Patient(
      ...
      facilityId: 'fac-001',
      totalAuthorizations: 4, approvedAuthorizations: 4, pendingAuthorizations: 0,
      mrn: 'MRN-0023456',
    ),
    Patient(
      ...
      facilityId: 'fac-003',
      totalAuthorizations: 20, approvedAuthorizations: 20, pendingAuthorizations: 0,
      mrn: 'MRN-0078901',
    ),
    Patient(
      ...
      facilityId: 'fac-001',
      totalAuthorizations: 3, approvedAuthorizations: 3, pendingAuthorizations: 0,
      mrn: 'MRN-0012345',
    ),
    Patient(
  ...
  static const List<Doctor> _defaultDoctors = [
    Doctor(
      ...
      totalRequests: 142, approvedRequests: 142, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 3200,
    ...
    Doctor(
      ...
      totalRequests: 89, approvedRequests: 89, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 4100,
    ...
    Doctor(
      ...
      totalRequests: 67, approvedRequests: 67, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 2800,
    ...
    Doctor(
      ...
      totalRequests: 98, approvedRequests: 98, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 2400,
      cmsSpecialtyCode: '06', isActive: true,
    ...
    Doctor(
      ...
      totalRequests: 113, approvedRequests: 113, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 3600,
    ...
    Doctor(
      ...
      totalRequests: 205, approvedRequests: 205, rejectedRequests: 0,
      approvalRate: 1.0, avgProcessingTimeMs: 2100,
  ...
  static final List<AiDecision> _defaultAiDecisions = [
    ...
    AiDecision(
      ...
      riskScore: 0.08,
      appealLikelihood: 0.04,
      appealConfidenceLow: 0.02,
      appealConfidenceHigh: 0.07,
      autoEscalated: false,
      processedAt: DateTime.now().subtract(const Duration(hours: 5)),
      processingTimeMs: 3120,
      finalJustification:
          'Authorization approved. MRI Brain without contrast (CPT: 70553) meets medical necessity criteria for the submitted diagnosis. Clinical documentation confirms compliance with policy guidelines.',
      fraudSignals: {
        'Billing Frequency Outlier': 0.05,
        'Provider Utilization vs CMS Benchmark': 0.08,
        'Duplicate Request Indicator': 0.02,
        'Geographic Anomaly': 0.01,
      },
      reasoningChain: [
        const AiReasoningStep(
          stepNumber: 1, title: 'Diagnosis Validation',
          description: 'ICD-10 code verified and approved for requested procedure.',
          citedValue: 'ICD-10: G44.209 — Tension Headache, Unspecified',
          policyRef: 'Policy §2.1.7 — Neurological Conditions',
          dataSource: AppConstants.dataSrcCms, passed: true, score: 0.95,
          details: ['ICD-10 G44.209 is valid', 'Advanced imaging approved under policy guidelines'],
        ),
        const AiReasoningStep(
          stepNumber: 2, title: 'Procedure Eligibility',
          description: 'CPT 70553 covered under plan with documented clinical necessity.',
          citedValue: 'CPT: 70553 — MRI Brain w/o & with contrast',
          policyRef: 'Policy §3.6.2 — Advanced Neuroimaging',
          dataSource: AppConstants.dataSrcCms, passed: true, score: 0.94,
          details: ['CPT 70553 covered under plan', 'Documentation satisfied step therapy criteria'],
        ),
      ],
    ),
    AiDecision(
      ...
      medicalNecessityScore: 0.90,
      riskScore: 0.10,
      appealLikelihood: 0.05,
      appealConfidenceLow: 0.03,
      appealConfidenceHigh: 0.08,
      autoEscalated: false,
      processedAt: DateTime.now().subtract(const Duration(hours: 1)),
      processingTimeMs: 4580,
      finalJustification:
          'Authorization approved. Lumbar spine procedure meets medical necessity standards and clinical criteria.',
      fraudSignals: {
        'Billing Frequency Outlier': 0.08,
        'Provider Utilization vs CMS Benchmark': 0.09,
        'Duplicate Request Indicator': 0.02,
      ...
      reasoningChain: [
        const AiReasoningStep(
          stepNumber: 1, title: 'Diagnosis Validation',
          description: 'Diagnosis verified and approved for lumbar spine fusion.',
          citedValue: 'ICD-10: M54.5 — Low Back Pain',
          policyRef: 'Policy §2.1.9 — Musculoskeletal', dataSource: AppConstants.dataSrcCms,
          passed: true, score: 0.92, details: ['ICD-10 M54.5 is valid', 'Clinical criteria met'],
        ),
        const AiReasoningStep(
          stepNumber: 2, title: 'Medical Necessity Assessment',
          description: 'Medical necessity verified and approved.',
          citedValue: 'Necessity Score: 90%',
          policyRef: 'Policy §4.2 — Musculoskeletal Necessity', dataSource: AppConstants.dataSrcCms,
          passed: true, score: 0.90, details: ['Necessity criteria satisfied'],
        ),
      ],
    ),
    AiDecision(
  ...
  static final List<AuthorizationRequest> _defaultAuthorizations = [
    ...
    AuthorizationRequest(
      ...
      decidedAt: DateTime.now().subtract(const Duration(hours: 4)),
      processingTimeMs: 3100, aiDecisionId: null,
      isUrgent: true, slaStatus: 'within_sla', dataSource: AppConstants.dataSrcCms,
      cmsNpiNumber: '2345678901', cmsSpecialty: 'Oncology',
      reviewerNotes: 'Approved per oncology fast-track guidelines.',
    ),
    AuthorizationRequest(
      ...
      reviewerNotes: 'Approved based on verified clinical documentation.',
      slaStatus: 'within_sla', dataSource: AppConstants.dataSrcCms,
    ),
    AuthorizationRequest(
      ...
      decidedAt: DateTime.now().subtract(const Duration(hours: 1)),
      processingTimeMs: 2500, aiDecisionId: null,
      reviewerNotes: 'Approved for MS treatment plan.',
    ...
    AuthorizationRequest(
      ...
      reviewerNotes: 'Approved after clinical review.',
    ),
    AuthorizationRequest(
    ...
    AuthorizationRequest(
      ...
      decidedAt: DateTime.now().subtract(const Duration(minutes: 30)),
      processingTimeMs: 1800, slaStatus: 'within_sla',
      dataSource: AppConstants.dataSrcDailyMed,
      reviewerNotes: 'Approved for Crohn disease treatment.',
    ),
    AuthorizationRequest(
    ...
    AuthorizationRequest(
      ...
      status: AuthorizationStatus.approved, priority: AuthorizationPriority.routine,
      requestedAt: DateTime.now().subtract(const Duration(hours: 4)),
      decidedAt: DateTime.now().subtract(const Duration(hours: 3)),
      processingTimeMs: 2100, reviewerNotes: 'Approved for neuroimaging evaluation.',
      slaStatus: 'within_sla', dataSource: AppConstants.dataSrcCms,
    ),
  ];
